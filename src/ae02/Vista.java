...
public class Vista {
	...
	//Nombre metodo: getBtnBuscar
	//Parametro de entrada: ninguno
	//Parametro de salida: JButton
	public JButton getBtnBuscar() {
		return btnBuscar;
	}

	//Nombre metodo: getBtnReemplazar
	//Parametro de entrada: ninguno
	//Parametro de salida: JButton
	...
	//Nombre metodo: getTextFieldBuscar
	//Parametro de entrada: ninguno
	//Parametro de salida: JTextField
	public JTextField getTextFieldBuscar() {
		return textField_Buscar;
	}

	//Nombre metodo: getTextFieldReemplazar
	//Parametro de entrada: ninguno
	//Parametro de salida: JTextField
	...
	//Nombre metodo: getTextAreaOriginal
	//Parametro de entrada: ninguno
	//Parametro de salida: JTextArea
	public JTextArea getTextAreaOriginal() {
		return textArea_Original;
	}

	//Nombre metodo: getTextAreaModificado
	//Parametro de entrada: ninguno
	//Parametro de salida: JTextArea
